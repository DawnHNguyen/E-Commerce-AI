...
interface ShippingApi {
    ...
    // Backend: @Post('calculate-fee') -> CalculateShippingFeeResponseSchema
    @POST("shipping/ghn/calculate-fee")
    suspend fun calculateShippingFee(
        @Body request: CalculateShippingFeeRequestDto
    ): Resource<CalculateShippingFeeResponseDto>
}